...
type
  TWordType = (wtLineFeed, wtSpaces, wtHalfComment, wtHalfStarComment,
    ...
    wtOperator, wtWord, wtNumber, wtHexNumber, wtNothing, wtAsm,
      wtCompDirective);
...
type
  ...
  TReservedType = (rtNothing, rtReserved, rtOper, rtDirective,
    ...
    rtUses, rtProcDeclare, rtFuncDirective, rtAbsolute, rtComment, rtRecCase,
      rtDot,
    rtCompIf, rtDotDot,
...
type
  ...
  TFillMode = (
    ...
    fmAddUseExcept);
      {: add new words, but do not use for capitalization, exclude directivs }
  ...
  TSettings = packed record
    ...
    StartCommentOut: TCommentArray;
      {: special comment to start unformatted section }
    ...
    AlignVarPos: Byte;
      {: position to align variant/constant declarations (the colon) }
