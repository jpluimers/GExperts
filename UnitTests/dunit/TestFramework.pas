{#(@)$Id: TestFramework.pas 44 2012-09-25 01:05:50Z neuromancer $ }
...
const
  rcs_id: string = '#(@)$Id: TestFramework.pas 44 2012-09-25 01:05:50Z neuromancer $';
  rcs_version : string = '$Revision: 44 $';
