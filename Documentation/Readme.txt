...
-----------------------------------------------
- The following features are not supported under Delphi 8 - XE6:
...
- The compiler replacement option of the Code Proofreader is only partially
  working under Delphi 7-XE6.  It does not correct when an identifier is
...
version such as 6, 7, 8, 2005, 2006, 2007, 2009, 2010, XE1, XE6, etc.):
...
CHANGE LOG
----------------------
VERSION 1.37 (April 2014)
- General: Added support for RAD Studio XE3, XE4, XE5, and XE6 (with help from
  Jeroen Pluimers).  Various minor big fixes.
...
GExperts is copyright 1996-2014 by GExperts, Inc, Erik Berry, and several
