...
-----------------------------------------------
- The following features are not supported under Delphi 8 - XE5:
...
- The compiler replacement option of the Code Proofreader is only partially
  working under Delphi 7-XE5.  It does not correct when an identifier is
...
version such as 6, 7, 8, 2005, 2006, 2007, 2009, 2010, XE1, XE5, etc.):
...
- General: Added support for RAD Studio XE3, XE4, and XE5 (with help from
